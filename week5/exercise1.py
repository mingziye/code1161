...
def calculate_hypotenuse(base, height):
    base = 3
    height = 4
    caculate_hypotenuse = (base**2 + height**2)**0.5
    return caculate_hypotenuse
...
def calculate_area(base, height):
    base = 3
    height = 4
    caculate_area = base*height/2
    return caculate_area
...
def calculate_perimeter(base, height):
    base = 3
    height = 4
    calculate_perimeter = base*height
    return calculate_perimeter

def calculate_aspect(base, height):
    base = 3
    height = 4
    caculate_aspect = "tall"
    return caculate_aspect
